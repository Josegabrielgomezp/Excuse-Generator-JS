...
let when = ['before the class.', 'right in time.', 'when I finished.','during lunch.', 'while I was praying.','when i was on my way', "before i leaved my home"];
...
function createExcuse(){
	var s = who[ getRandom(6) ] + ' ' + what[ getRandom(6) ] +
						' my ride ' + when[ getRandom(7) ];
